...
semanticValue :: AST.AboutOperators -> AST.VarSet -> AST.Term -> Either [AST.ParseError] AST.Expression
semanticValue ops knownVars term = case runWriter $ runReaderT (go term) knownVars of
