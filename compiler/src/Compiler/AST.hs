...
data Expression =
    ...
    Record [Abstraction] deriving (Eq, Show)
...
data ImportListing = ImportAll | ImportOnly Destructuring | ImportHiding Destructuring | ImportAs ValidIdentifier
    deriving (Eq, Show)
...
data TopLevelDeclaration =
    ...
    TypeDeclaration DeclarationModule TypeExpression deriving (Eq, Show)
